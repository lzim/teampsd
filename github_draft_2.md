...
8.  After review, the reviewer will push the "feature-gh-pages_*" branch into the gh-pages branch.  This will trigger the bookdown publishing action to publish the updated manual.
