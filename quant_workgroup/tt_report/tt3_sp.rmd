...
rw_ord1 <- c("New Patient Start Rate (mean)(pts/wk)", "New Patient Wait Time (median)(wks)",
             "High Risk Flag Rates (mean)(pts/wk)", "Time to Unflag High Risk Patients (median)(wks)",
             "Engagement Time Before Ending (median)(wks)", "Symptom Proportions (High Symptom %)",
