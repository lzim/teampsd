...
11. Click Select All under all + Quick Add options.
12. Click the Close button.
13. Scroll down to click on Step 3 to review a specific site to track engagement and see how many people completed this survey for a specific site.
14. Scroll down and click the Save Report button.
15. Receive the confirmation that the site level report was created. Click on Return to My Reports & Exports.
16. Review the total sites listed and View Report button.
17. You'll see the number of results returned, the number of records queried, and feedback.
18. Click back on the My Reports & Exports tab to produce the Provider Enrollment Table.
19. Click the + Create New Report button to create the provider enrollment report, which will track enrollment for all sites moving forward.
20. Fill in the Name of Report: field.
21. Scroll down to Step 2 and click the  + Quick Add button.
22. Scroll down to the Demographics section, choose Select All, and click Close button.
23. Scroll all the way to the bottom and click Save Report button. A pop-up will appear saying your report has been saved.
24. Click the View report button. You will see the Provider Enrollment Table.
25. There is a PHS standard format for enrollment tables.
26. Navigate to the enrollment_tables folder in the appropriate folder within Team PSD > Grants.
