...
psypar1a <- read_excel("./original/ModelParameters (2).xlsx", sheet = "PSYParams", col_names = FALSE, range = "B35:D36")

psypar1b <- read_excel("./original/ModelParameters (2).xlsx", sheet = "PSYParams", col_names = FALSE, range = "B40:D43")

flow <- read_excel("./original/ModelParameters (2).xlsx", sheet = "PSYParams", col_names = FALSE, range = "B3:D7")

rvi <- read_excel("./original/ModelParameters (2).xlsx", sheet = "PSYParams", col_names = FALSE, range = "B8:D12")

med <- read_excel("./original/ModelParameters (2).xlsx", sheet = "PSYParams", col_names = FALSE, range = "B13:D14")

rvi_after <- read_excel("./original/ModelParameters (2).xlsx", sheet = "PSYParams", col_names = FALSE, range = "B15:D23")

med_after <- read_excel("./original/ModelParameters (2).xlsx", sheet = "PSYParams", col_names = FALSE, range = "B24:D32")
```
