...
rvi_mod <- rvi %>%
  ...
  select(Type,`Appointment Group`, `Flow Group`, rate)
...
## Engagement {.tabset .tabset-fade .tabset-pills}

### Graph Option: Interactive

```{r engage1, echo= FALSE, warning=FALSE, message=FALSE}
...
```{r engage2, echo= FALSE, warning=FALSE, message=FALSE, fig.align= "center"}
...
```{r duration1, echo= FALSE, warning=FALSE, message=FALSE}
...
```{r duration2, echo= FALSE, warning=FALSE, message=FALSE, fig.align="center"}
