...
##### *Adapting exercise from didactices to increase parrallel process for Facilitation Guide*
###### Swap Mushiana   edit: 5.2.17
```{r}
 ...
 * **Non-linear System Behavior - Exponential Growth**
    + *Power*- exponential growth occurs rapidly 
    + *Insidious* -“sneaks up” on you. Example: folding a peice of paper 36 plus times. 
 ...
 * **Non-linear System Behavior - Steady State**
    ...
    + Stakeholders’ may have belief, *“We cannot make improvement.”*
```{r}
...
* **Ratio Exercise**
    ...
    + Prompt stakeholders to tell “feedback stories” to a “what if” scenario proposed by facilitator. 
```{r}
