...
2. Click on the Experiments section. Pull up the prior experiment by clicking on the red down arrow next to the text *Select Previous Experiment to Set Experimental Values to Former State*. Click the red "Go" button.  

3. Check the box to include the text from that experiment. Click the blue "Go" button.  
    + Note that the sliders have moved to the settings for that experiment.  

4. Click on the Output section. Click on Expand to maximize the section. Select another earlier experiment to compare to the one you have just pulled up.  

5. Note the variables that were manipulated in the two experiments.  

6. Review the findings (graphs) from the two experiments in the Results Dashboard and the text in the Hypothesis, Findings and Decisions boxes.  
