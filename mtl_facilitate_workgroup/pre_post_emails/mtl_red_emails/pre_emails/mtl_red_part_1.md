...
| --- |
|**Before Our Next Team Meeting: Wednesday 3/10 at 9-10am Pacific**|
...
[<img src = "https://github.com/lzim/teampsd/blob/master/resources/logos/tms_logo.jpg?raw=true" height = "75" width = "75">](https://www.tms.va.gov/SecureAuth35/) To register for CEUs, **before we meet**: </br> 1. Log in to [**TMS**](https://mtl.how/tms) and click the **"Learning"** box under "My Info". </br> 2. Click on the listing's title here [**"Modeling to Learn Red, Part 1" (Course ID: 43879)**](https://va-hcm03.ns2cloud.com/learning/user/catalogsearch/catalogSearchDispatchAction.do?searchType=filteredSearch&keywords=43879) and click **"Register Now"**. </br> 3. Find your team's meeting time (Note: Times may be in Eastern time), click **"Register Now"** and fill out the form, and **"Confirm"** the registration. </br> 4. **After we meet**, come back to the [**course listing**](https://va-hcm03.ns2cloud.com/learning/user/catalogsearch/catalogSearchDispatchAction.do?searchType=filteredSearch&keywords=43879) and click **"Start Course"** and click **"Confirm Attendance"**.
