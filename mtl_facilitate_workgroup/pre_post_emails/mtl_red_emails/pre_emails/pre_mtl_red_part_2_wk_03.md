...
# This week we're modeling to learn how to produce team data table.
...
| [<img src = "https://raw.githubusercontent.com/lzim/teampsd/master/resources/logos/mtl_how_data_sm.png" height = "45" width = "75">](http://mtl.how/data) **1. Review the HF, Diag, Enc and SP tabs to find a patient (zoom in) and find a team trend (zoom out). 2. Go to to [mtl.how/data](https://mtl.how/data) and find Team data UI and team_data folders.** [Click here for the MTL Red Part II guide.](https://github.com/lzim/mtl/blob/master/red/part2/part2_learner/mtl_red_part_2_see.md)|
