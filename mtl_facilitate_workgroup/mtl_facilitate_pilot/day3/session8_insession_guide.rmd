...
2.	Review your saved runs and rename them if you feel you need to.

3.	Review the data files you have uploaded for use and make sure you have what you want.

4.	You can continue with the previous session or Start a new session in the Aggregate module with the team data file you’d like to use.
