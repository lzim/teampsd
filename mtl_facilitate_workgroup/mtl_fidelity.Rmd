...
### Session 5 - Simulation User-interface (sim UI) - Log-in and Team Data in Experiments Tile
...
### Session 6 - Simulation User-interface (sim UI) - Main Tile Model Diagram - Telling a Systems Story
...
**Team Meeting** - *MTL* Session 8 - Team Experiment 1 - Review Expanded Outputs to compare Experiment 1 and the Base Case |
**Done/Do** - 15 minutes for Done/Do  |
...
**Execise Resources** - *MTL* resources for each module are available at mtl.how - either mtl.how/4_care_coordination mtl.how/5_medication_management mtl.how/6_psychotherapy mtl.how/7_aggregate |
**MTL Live** - MTL Session 8 Learner Guide (SEE file) - Enter text for experiment 1 in Q/H/F/D (100% complete in Facilitator Dashboard) |
**MTL Facilitate** - MTL Session 8 Facilitator Guide (SAY file) - "D" Decision text should be to decide on experiment 2, which will be run at the next meeting.      |
**Done/Do** - 15 minutes for Done/Do  |
**Done** - Team Lead Ran Experiment 1 and team reviewed Expanded Outputs tile to compare the basecase and experiment 1.
**Do** - Select Team Lead. Select standing team meeting time. 
**Post-email** - Sent the week after the team meeting (off-week) - "We decided..."
