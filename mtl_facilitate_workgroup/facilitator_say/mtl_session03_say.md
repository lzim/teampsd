...
b. Find a variable that is important to your team. Look at how the variable is estimated in the table. 
   ...
   - If Suicide Prevention is selected,key variables of interest may include high-risk flag rates, engagement times before ending treatment in a specific setting, engagement time before stepping up or down between care settings, wait times, and the ratio of high to low symptom patients in each setting.
