...
| --- | --- | 
| We logged into mtl.how/sim and explored the Expanded Outputs Dashboard for the basecase (bc) and used the worksheet to prepare for experiment 1.| TeamPSD Facilitators will introduce Introducing MTL Experiments to compare against the Base Case (bc) of no change.
