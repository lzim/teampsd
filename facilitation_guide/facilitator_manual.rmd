...
## Technology and Mechanics
    ...
    Data interface in SharePoint – software?, browser specs, login, other? *Q4Andrew* (Detailed instructions in Appendix C.)
    
    Model interface in Forio – browser specs, login, other? *Q4Tom* (Detailed instructions in Appendix D.)
