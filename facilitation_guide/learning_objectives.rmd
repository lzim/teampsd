...
Gather opinions about the type of data that is most salient for provider disciplines (...then in future sessions can draw a link between daviergent types of data needs per provider group in the context of the system. 
...
5.  Compare and contrast "balancing" and "reinforcing" feedback loops.
...
2.	Distinguish between external and team-based drivers affecting new patient referrals and understand how these explain wait times and the ability to start patients in care coordination.  
...
1.	Describe team decisions about return visit intervals can help to optimize the number of appointments available for existing medication management patients by diagnostic cohort. 
2.	*Explore how differences in desired average return visit intervals, missed appointment rates, and overbooked appointments across four main diagnostic cohorts affect the team’s ability to provide evidence-based medication management services.*  
3.  Apply lessons learned from Care Coordination sessions to optimizing delivery of Med Management across the four main diagnostic cohorts.
4. Specify useful inferences derived from the team's successes and failures of "rules-of-thumb" for managing Care Coordination in the more complicated context of Med Management.
