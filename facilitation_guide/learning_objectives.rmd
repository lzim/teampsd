...
3.  Name the two major units, or "stocks", in the Care Coordination model.   
...
2.	Distinguish between external and team-based drivers for new patient referrals and understand how these are connected to wait times and the ability to start patients in care coordination. -- This is a strong learning objective; it seems that many providers will resonate with having to navigate between "external and team-based drivers." I wonder if setting the stage around this LO makes sense. 
...
4.	Distinguish between external and team-based drivers of patient scheduling and understand how these are connected to care quality and the ability to start new patients, and patients who go beyong three months in psychotherapy.  -- This seeems to the broad goal of this session
