...
CORE OBJECTIVE: To understand Modeling to Learn (MTL) as a way to address a team's needs in meeting VA standards and initiatives using localized patient and provider data.
...
Session 2. Our Data  
CORE OBJECTIVE: To develop familiarity in accessing localized team data.
...
CORE OBJECTIVE: To simulate clinic units (stocks: e.g., appointments available, and flows: e.g., booking rate) in the Care Coordination model in order to improve team decision making.
...
CORE OBJECTIVE: To compare and contrast "balancing" and reinforcing" feedback loops affecting patient flow through care coordination appointments.
...
CORE OBJECTIVE: To examine external and team-based factors as well as trade-offs affecting appointments for new versus existing patients in care coordination.
...
CORE OBJECTIVE: To examine the impact of return visit intervals on patient flow through medication management appointments. 
