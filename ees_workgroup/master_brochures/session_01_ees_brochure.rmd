...
The purpose of this knowledge based webinar is to empower local clinic staff to use real-time clinic data and a customized system modeling tool to make decisions that optimize their delivery of timely, evidence-based psychotherapies and pharmacotherapies (EBPs).
...
| 30 Minutes	|	Team Activity on Shared Vision		|	Facilitator |		Interactive		|
