...
**3. In the context of *Modeling to Learn* the acronym "EBP" stands for:**	
...
**4. A primary purpose of the *Modeling to Learn* data user interface (UI) is to help a clinic team:**	
...
**5. The “ClinicSelection” tab in the MTL data UI allows the user to:**	
...
c. Diagnosis by clinician name  

d. Monthly data according to services provided by a VA clinic  
...
d.Team priorities for individual patient care  
