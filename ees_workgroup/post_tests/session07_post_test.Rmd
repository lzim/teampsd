...
# *Modeling to Learn* how to evaluate our base case of no change.
...
a. The model's expected outcomes if we make no change to clinic operations; it is determined by using the assumptions that the team consider are most likely to occur and the team data from the past two years 
...
**4. What is the purpose for the text in the “Our Question” box on the *MTL* Outputs screen?**	
...
**5. What is the purpose for the text in the “Our Hypothesis” box on the *MTL* Outputs screen?**
...
**7. What is the purpose for the text in the “Our Findings” box on the *MTL* Outputs screen?**

a. The purpose of the “Our Findings” text is to describe your team's findings, insights and conclusions from running an experiment.

b. The purpose of the “Our Findings” text is to outline the expected oscillations in existing and new patient care that will occur as staffing changes.

c. The purpose of the “Our Findings” text is to detail the findings the team would like to experience in the clinic as a result of making changes in the simulation model.

d. The purpose of the “Our Findings” text is to guide the team into making staffing, patient care, and scheduling decisions for the next two months.


**8. What is the purpose for entering text into the “Our Decisions” box on the *MTL* Outputs screen?**

a.	The purpose of the “Our Decisions” text is to document what the team has learned in an experiment and the changes that the team may be ready to make in practice or select what other experiments they will run. 

b.	The purpose of the “Our Decisions” text is to guide the team into making staffing, patient care, and scheduling decisions for the next two years.

c.	The purpose of the “Our Decisions” text is to detail the top 3 decisions the team would like to experience in the clinic as a result of making changes in the simulation model.

d.	The purpose of the “Our Decisions” text is to determine one change the clinic team will make to new patient care that can impact quality care measures.
