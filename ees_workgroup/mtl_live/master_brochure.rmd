...
- Social workers
- Nurses
- Counselors (can advertise, but cannot list as an accreditation option)
- Certified peer-support specialists (can advertise, but cannot list as an accreditation option)
- Other professional disciplines; and (can advertise, but cannot list as an accreditation option)
- Trainees (e.g., practicum, intern, resident and fellow) (can advertise, but cannot list as an accreditation option)

## Accreditations: 
- ACCME and ACCME-NP (this covers psychiatry, physicians, nurse practictioners and physicians assistants)
- APA
- ANCC-NP
- NBCC
- ASWB
