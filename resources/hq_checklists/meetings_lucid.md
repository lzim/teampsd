...
[ ] 3. Confirmation and Consent 
- [ ] Ask meeting attendees **Is everyone ok with us recording this meeting?**  
...
- [ ] 3. When taking notes on an **Issue** with a **GitHub Number** comments should be tracked in the corresponding **GitHub Numbered Issue** directly  (e.g. https://github.com/lzim/teampsd/issues/819).
...
- [ ] 1. Before you **End the Meeting** double-check that no one else is **Still Writing Notes** as changes will be **Lost**

- [ ] 2. Then select **End Meeting**
