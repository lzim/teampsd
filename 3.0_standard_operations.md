...
Labels shall be assigned a color, expressed in lowercase and use an underscore in lieu of a space. Below are lists of labels and their purpose for two repos.

#### Team PSD Repo Labels

The Team PSD repository uses the following labels and descriptions:
<img alt="Image of Team PSD repository labels." src="https://raw.githubusercontent.com/lzim/teampsd/gh-pages/images/teampsd_repo_labels.png">

#### Research Repo Labels

The Research repository uses the following labels and descriptions:
<img alt="Image of Research repository labels." src="https://raw.githubusercontent.com/lzim/teampsd/gh-pages/images/research_repo_labels.png">
...
3 kinds of "Bugs" - Bugs are rapport-builders and need to be handled in relationship with our partners.

1. "Bug" - something not working as intended.
2. "Andon" - "Stop the Line" - the problem could lead to a reduction in the quality of _MTL_
